                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            <button class="btn btn-warning btn-flat pull-right" data-toggle="modal" data-target="#addModal">添加角色</button>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                    ...
                    <form class="form-horizontal">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="inputName" placeholder="角色">
                                </div>
                            </div>
                            <!-- select -->
                            <div class="form-group">
